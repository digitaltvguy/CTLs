...
// basically when oces is divided by SCALE_MAX (ocesScale) any value below 0.0001 will be clipped
  ...
  /* --- Encode linear code values with transfer function --- */
    float outputCV[3];
    outputCV[0] = CV_BLACK + (CV_WHITE - CV_BLACK) * BBC_r8( linearCV[0],1.2);
    outputCV[1] = CV_BLACK + (CV_WHITE - CV_BLACK) * BBC_r8( linearCV[1],1.2);
    outputCV[2] = CV_BLACK + (CV_WHITE - CV_BLACK) * BBC_r8( linearCV[2],1.2);
